                              ...
                              {profile.status === 'pending' && (
                                <div className="flex gap-2 justify-end">
                                  <Button
                                    ...
                                    className="bg-green-600 hover:bg-green-700 h-6 text-xs transition-all duration-200 hover:scale-105"
                                  >
                                  ...
                                  <Button
                                    ...
                                    className="text-red-600 border-red-200 hover:bg-red-50 h-6 text-xs transition-all duration-200 hover:scale-105"
                                  >
